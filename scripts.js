...
const APP = {
    backendUrl: 'https://script.google.com/macros/s/AKfycbyiF4UO6cdCG5kDldLBRMZ2S9dFQhfgiMFNzSXxSO_2P4BPiicNZ5_K2HHV-dvGXrI8/exec',
    ...
    defaultDocs: [
        {
            ...
            author: 'Intizarul Imamul Muntazar',
            description: 'Wannan yana Dauke da cikakkiyar gabatarwar Intizarul Imamul Muntazar tare hadafin samr da Intizarul Imamul Muntazar.',
            language: 'hausa',
            category: 'ideology',
            source: 'intizar',
            type: 'PDF',
        ...
        {
            id: 'core-2',
            title: 'Fassarar Littafin Sirru Hijabi',
            author: 'Dr Arkam Barakat',
            description: 'Fassarar Litaffin Sirru hijabi wato sirrin hijabina wanda Dr Arkam Barakat ta wallafa Intizarul Imamul Muntazar Suka fassra shi cikin harshen Hausa.',
            language: 'hausa',
            category: 'ideology',
            source: 'intizar',
            type: 'PDF',
        ...
        {
            id: 'core-3',
            title: 'Mujallar Intizar ta Ashura 1442H',
            author: 'Intizarul Imamul Muntazar',
            description: 'Wannan Mujallar Intizarul Imamul Muntazr Karo na hudu wanda ta wallafa a Ashura 1442H/2020',
            language: 'hausa',
            category: 'magazine',
            source: 'intizar',
            type: 'PDF',
        ...
        {
            id: 'core-4',
            title: 'Mujallar Intizar ta Shaaban 1442H',
            author: 'Intizarul Imamul Muntazar',
            description: 'Wannan Mujallar Intizarul Imamul Muntazr Karo na hudu wanda ta wallafa a Nisfu Shaaban 1441H/2020.',
            language: 'hausa',
            category: 'magazine',
            source: 'intizar',
            type: 'PDF',
        ...
        {
            id: 'core-5',
            title: 'Mujallar Intizar ta Maulud 1442H',
            author: 'Intizarul Imamu; Muntazar',
            description: 'Wannan Mujallar Intizarul Imamul Muntazr Karo na hudu wanda ta wallafa a Maulud 1442H/2020.',
            language: 'hausa',
            category: 'magazine',
            source: 'intizar',
            type: 'PDF',
        ...
        {
            id: 'core-6',
            title: 'Kitabul Ghaybat Na Sheikh Ɗusi',
            author: 'Sheikh Ɗusi',
            description: 'Littafin ya ƙunshi cikakken bayani game da ghaybat (ɓoyewa) da bayyanar Imam Mahdi (A.J.F) a cikin harshen Larabci.',
            language: 'arabic',
            category: 'ideology',
            source: 'intizar',
            type: 'PDF',
        ...
        {
            id: 'core-7',
            title: 'Imam Mahdi the last saviour',
            author: 'Sayyid Abidi',
            description: 'Wannan littafi na cikin harshen Turanci, ya bayyana cikakken bayani game da Imam Mahdi (A.J.F) a matsayin mai ceto na ƙarshe.',
            language: 'english',
            category: 'ideology',
            source: 'intizar',
            type: 'PDF',
        ...
        {
            id: 'core-8',
            title: 'Imam Mahdi the just leader of the humanity',
            author: 'Allamah Amini',
            description: 'Littafin ya ba da cikakken bayani game da Imam Mahdi (A.J.F) a matsayin shugaban adalci na ɗan adam.',
            language: 'english',
            category: 'ideology',
            source: 'intizar',
            type: 'PDF',
    ...
    // External documents - EMPTY ARRAY
    externalDocs: [],
...
function getCategoryDisplayName(code) {
    const categories = {
        ...
        'sermons': 'Wa\'azi',
        'mujalla': 'Mujalla',  // ADDED: Mujalla category
        'other': 'Sauran'
    };
            ...
            <div class="card-footer">
                ...
                ${doc.type !== 'WEB' ? 
                    `<a href="${doc.url}" download class="card-btn download">
                        <i class="fas fa-download"></i> Sauke  <!-- CHANGED: Zazzage to Sauke -->
                    </a>` : ''
                }
            </div>
        `;
        ...
        <div class="details-actions">
            ...
            ${!isExternal ? 
                `<a href="${fileUrl}" download class="btn btn-secondary" style="flex: 1;">
                    <i class="fas fa-download"></i> Sauke PDF  <!-- CHANGED: Zazzage PDF to Sauke PDF -->
                </a>` : ''
            }
        </div>
    `;
...
// ==================== EXTERNAL DOCUMENTS FUNCTIONS ====================

// Function to add external document without breaking anything
function addExternalDocument(docData) {
    APP.externalDocs.push(docData);
    updateExternalDocsVisibility();
    // If on library page, refresh view
    if (APP.currentPage === 'library') {
        applyFilters();
    }
}

// Function to update external documents visibility
function updateExternalDocsVisibility() {
    // Check if there's an external documents section in the DOM
    const externalSection = document.querySelector('.external-documents-section');
    if (!externalSection) return;
    
    if (APP.externalDocs.length > 0) {
        externalSection.classList.add('has-content');
    } else {
        externalSection.classList.remove('has-content');
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        window.onSurahComplete = function() {
            ...
            // Update external docs visibility
            updateExternalDocsVisibility();
...
function addDynamicStyles() {
    ...
    styles.textContent = `
        /* External documents section - hidden by default */
        .external-documents-section {
            display: none !important;
        }
        
        /* Only show external documents if we explicitly add them */
        .external-documents-section.has-content {
